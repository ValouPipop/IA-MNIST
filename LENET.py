# -*- coding: utf-8 -*-
"""
Created on Wed Jun  4 16:15:16 2025
...
# -*- coding: utf-8 -*-
"""
Created on Wed Jun  4 15:48:28 2025
...
model1 = Sequential()
model1.add(Convolution2D(6, (5, 5), strides=(1, 1), padding='same', activation='relu', input_shape=(28, 28, 1)))
model1.add(MaxPooling2D(pool_size=(2,2)))
model1.add(Convolution2D(16, (5, 5), strides=(1, 1), padding='valid', activation='relu'))
model1.add(MaxPooling2D(pool_size=(2,2)))
model1.add(Flatten())
